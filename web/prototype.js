...
function ensureSelections() {
  ...
  if (!state.reviewRunId && defaultRunId) {
...
function renderJobsDetail() {
  ...
  elements.jobsDetailSubtitle.textContent = `${numberValue(run.sourceRecordCount)} records · ${numberValue(run.dedupCandidateCount)} pending review`;
  elements.jobsDetailBody.innerHTML = `
    ...
    <section class="detail-section">
      ...
      <div class="fact-grid">
        ...
        <div class="fact-row"><span class="fact-label">Pending review</span><div class="fact-value">${escapeHtml(String(numberValue(run.dedupCandidateCount)))}</div></div>
